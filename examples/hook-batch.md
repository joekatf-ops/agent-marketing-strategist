# Frozen Example: Hook Batch

This is a six-option pre-production set for the SLA execution inside `CONTST004`. It remains one
launch ad. Selecting one package does not create six ads.
...
- Complete final ad name:
  `CONTST004_NNT_REMOTE_WORKERS_CABLE_SEARCH_SLA_COMPARISON_PDP_POSTIDXXX`
- Production constraints: one tabletop set, hands only, phone camera, two pouches, six common cables

## 2. Evidence and claim gate

- `EVD-PROD-001`, verified product fact: transparent mesh divider and six elastic cable loops
- `EVD-MKT-021`, market evidence: 63 category reviews from six competitor pages
- `EVD-MKT-022`, market evidence: 21 reviewed comments mention digging, tangles or forgotten cables
- `EVD-CLAIM-006`, approved wording: "See your cables at a glance."
- Prohibited: waterproof, indestructible, fits every charger, prevents forgetting, customer results

## 3. Hook packages

### Hook 1: Open, see, select
...
11. **On-screen anchor:** "See it at a glance"
12. **Body handoff:** Show the transparent divider and six loops, then repeat the selection
13. **Proof and claims:** `EVD-PROD-001` and `EVD-CLAIM-006`, approved for Australia
14. **Destination and CTA:** `PDP`; Shop Now
15. **People, assets and location:** hand model, SnapGrid, six cables, overhead phone rig, neutral desk
...
### Hook 2: Same cables, different search
...
10. **Spoken opening:** "Same six cables. Two very different ways to find one."
11. **On-screen anchor:** "Searching vs seeing"
12. **Body handoff:** Repeat under the same conditions, then identify only the divider and loops
13. **Proof and claims:** `EVD-PROD-001`; fair same-item demonstration; no speed claim
14. **Destination and CTA:** `PDP`; Shop Now
15. **People, assets and location:** hand model, SnapGrid, plain pouch, matched cable sets, locked camera, desk
...
10. **Spoken opening:** "I packed every cable and still had to empty the pouch to find one."
11. **On-screen anchor:** "Packed is not visible"
12. **Body handoff:** Repack the same items into visible fixed positions and show the product layout
13. **Proof and claims:** `EVD-MKT-022` for the market-language pattern; `EVD-PROD-001` for product facts
14. **Destination and CTA:** `PDP`; Shop Now
15. **People, assets and location:** creator, two pouches, cable set, phone tripod, home-office desk
...
10. **Spoken opening:** "New desk, low battery, and no time to search the pouch."
11. **On-screen anchor:** "When the cable needs to be obvious"
12. **Body handoff:** Move from the situation to the visible divider and loop layout
13. **Proof and claims:** `EVD-MKT-021` for carry situations; `EVD-PROD-001` for product facts
14. **Destination and CTA:** `PDP`; Shop Now
15. **People, assets and location:** hand model, laptop, phone, SnapGrid, shared-workspace desk
16. **Complete final ad name:** `CONTST004_NNT_REMOTE_WORKERS_CABLE_SEARCH_SLA_UGC_PDP_POSTIDXXX`
...
### Hook 5: More pockets can hide more
...
10. **Spoken opening:** "More pockets can mean more places to check for the same cable."
11. **On-screen anchor:** "Pockets are not visibility"
12. **Body handoff:** Show the conditional comparison, then the verified divider and loops
13. **Proof and claims:** `EVD-PROD-001`; fair visual comparison; conditional wording required
14. **Destination and CTA:** `PDP`; Shop Now
15. **People, assets and location:** hand model, SnapGrid, multi-pocket pouch, cable set, desk
16. **Complete final ad name:** `CONTST004_NNT_REMOTE_WORKERS_CABLE_SEARCH_SLA_COMPARISON_PDP_POSTIDXXX`
...
10. **Spoken opening:** No speech for two seconds, then "It was already in view."
11. **On-screen anchor:** "Find the orange cable"
12. **Body handoff:** Identify the divider and six loops, then show the closed-to-open sequence
13. **Proof and claims:** `EVD-PROD-001` and the recorded visual object; no behaviour guarantee
14. **Destination and CTA:** `PDP`; Shop Now
15. **People, assets and location:** hand model, SnapGrid, six cables including one orange cable, overhead rig
16. **Complete final ad name:** `CONTST004_NNT_REMOTE_WORKERS_CABLE_SEARCH_SLA_DEMO_PDP_POSTIDXXX`
...
1. Hook 2: highest contrast and learning value, after the fairness check.
2. Hook 1: clean product-proof control with the lowest production risk.
3. Hook 6: distinct silent-first opening with a visible proof object.
4. Hook 4: strong Who situation with modest production needs.
5. Hook 5: valuable category reframe after claim-owner review.
6. Hook 3: useful language route, but less direct proof than the demonstrations.

Hook 2 is selected. The approved production record uses its primary hook and launches only
`CONTST004_NNT_REMOTE_WORKERS_CABLE_SEARCH_SLA_COMPARISON_PDP_POSTIDXXX` for this SLA execution.
