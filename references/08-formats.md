...
| Meme / pattern interrupt | Familiar meme structure, persona-specific tension, subtle product payoff | Attention, relatability, emotional recognition | UWA |
...
| Native interview / vox pop | Question hook, rapid answers, insight or reveal, CTA | Social proof, curiosity, multiple persona perspectives | UWA, PRA | 20 to 60 sec | High | Interviewer, participants, releases, location |
| Podcast | Cold-open insight, tension, explanation, natural CTA | Native conversation, contrarian hooks, persona-led pain | UWA, PRA | 30 to 90 sec | Medium | Podcast set, two mics, one or two speakers |
