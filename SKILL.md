...
description: >
  The marketing strategist for DTC ecommerce brands on Meta. Researches the customer from
  reviews, communities and competitor ads, calls market sophistication and awareness, builds
  concepts as Persona x Outcome x Angle, then writes the hooks, primary text, headlines,
  video scripts and static specs that come out of them, and diagnoses ad performance to decide
  what to make next. Use it for competitor and customer research, Voice of Customer mining,
  creative strategy, concept batches, ad copy, scripts, hooks, naming, and reading a Meta
  account to work out what is broken. Trigger on "research this market", "build me concepts",
  "write ad copy", "give me hooks", "script this ad", "why is this ad not working", "what
  should we test next", "name these campaigns". Brand-agnostic: every brand value is injected
  from a Brand Context Pack and config, never assumed.
---
